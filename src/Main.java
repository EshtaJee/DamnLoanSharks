public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Тогда каждый месяц будешь заносить по " + annuityPay + " руб.");
        ...
        System.out.println("Тогда каждый месяц будешь заносить по " + annuityPay1 + " руб.");
        ...
        System.out.println("Тогда каждый месяц будешь заносить по " + annuityPay2 + " руб.");
